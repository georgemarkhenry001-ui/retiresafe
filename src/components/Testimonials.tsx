  ...
  return (
    <section className="relative py-16 sm:py-20 lg:py-24 overflow-hidden bg-gradient-to-b from-white via-slate-50 to-white">
      ...
      <motion.div
        ...
        className="hidden md:block absolute -top-40 -left-40 w-[500px] h-[500px] rounded-full bg-indigo-200/40 blur-3xl pointer-events-none"
      />
      <motion.div
        ...
        className="hidden md:block absolute -bottom-40 -right-40 w-[460px] h-[460px] rounded-full bg-blue-200/40 blur-3xl pointer-events-none"
      />
